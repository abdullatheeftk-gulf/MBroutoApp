...
import com.example.mbroutoapp.ui.theme.EXTRA_SMALL_PADDING
import com.example.mbroutoapp.ui.theme.LightGray
import com.example.mbroutoapp.ui.theme.StarColor
...
fun RatingWidget(
    ...
    Row(
        modifier = modifier,
        horizontalArrangement = Arrangement.spacedBy(space = spaceBetweenStars)
    ) {
...
fun calculateStars(rating: Double): Map<String, Int> {
    ...
    LaunchedEffect(key1 = rating) {
        ...
        if (firstNumber in 0..5 && lastNumber in 0..9) {
            ...
            Log.d(TAG, "CalculateStars: invalid rating number ")
        }
...
fun FilledStarPreview() {
    RatingWidget(modifier = Modifier, rating = 0.8)
}
